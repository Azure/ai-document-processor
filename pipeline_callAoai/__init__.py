...
async def main(req: func.HttpRequest) -> func.HttpResponse:
    ...
    try:
        ...
        for blob in selected_blobs:
            process_blob_result = await process_blob(blob)
            processed_files.append(process_blob_result[0])  # Append the blob name
            errors.extend(process_blob_result[1])  # Append any errors
...
async def process_blob(self, blob) -> None:
    errors = []
